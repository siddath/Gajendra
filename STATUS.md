...
- Installed app: visible name `Gaja`, compatibility executable `Gajendra`, version 0.3.1, ad-hoc signature valid; installed and source-built binary SHA-256 `45ce51e5f9d2111e0f7c6cc61ff5c85fab5ad76178816a316d1184980487b4ba`; installed ICNS SHA-256 `ce14ad09bdc2dd48a48fa9a39c9407b356571ae207bdfa0bbaba8ec040b8faff`; bundled service SHA-256 `e37e1714d5912db9992a54573d0475398622e093337573eace2fb067476ef2d1`.
...
- Running installed runtime: relaunched as PID `95974`, with the persisted launcher at Bottom Right. A clean one-second hover left only the 60 × 60 pill visible; primary click opened the 660 × 610 detail card for the current Compact preference, and a second click closed it. Installed Accessibility proof covered the real search field, changing result counts, explicit no-match state, retained focus after Clear, the matching Organizer field, and ⌘A/⌘C/⌘V/⌘X in both surfaces. The immediately previous installed app is recoverable at `/Users/i556940/Applications/Gajendra.app.rollback-edit-shortcuts-20260816-004024`.
