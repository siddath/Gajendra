...
policies; that alone did not prove a fix. The extended test reproduced a Desktop switch on Dock
reopen. The repair remembers the last external app in memory and restores that tool on compact
reopen, while leaving explicit Organizer/setup interactions in their own window. The overlay
keeps explicit full-screen eligibility on all supported OS releases.
