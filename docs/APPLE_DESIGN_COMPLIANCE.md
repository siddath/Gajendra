...
| User control | Reversible Launch at Login, optional source enablement, confirmed app removal with metadata retention, and no required Accessibility permission. |
